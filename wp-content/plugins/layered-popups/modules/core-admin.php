	...
	function admin_settings() {
		...
		echo '
					...
					<tr>
						...
						<td>
							<a class="ulp-button ulp-button-small" onclick="return ulp_cookies_reset(this);"><i class="fa fa-close"></i><label>'.__('Reset Cookies', 'ulp').'</label></a>
...
/*			echo '
		...
		<div class="ulp-helper-window" id="ulp-helper-add-layer-window">
			<div class="ulp-helper-window-title">
				<a href="#" onclick="return ulp_helper_close();"><i class="fa fa-close"></i></a>
		...
		<div class="ulp-helper3-window" id="ulp-helper-window-message" style="width: 480px; height: auto;">
			<div class="ulp-helper-window-title">
				<a href="#" onclick="return ulp_helper3_close();"><i class="fa fa-close"></i></a>
				'.__('Message', 'ulp').'
			</div>
		...
		<div class="ulp-helper2-window" id="ulp-helper-window-label">
			<div class="ulp-helper-window-title">
				<a href="#" onclick="return ulp_helper2_close();"><i class="fa fa-close"></i></a>
...
<body>';
	...
	<div class="popup-charts">
		...
		'.($ulp->ext_options['count_impressions'] == 'on' ? '<div class="chart impressions-chart" style="width: '.$impressions.'%;">'.($impressions > 10 ? $row['impressions'] : '&nbsp').'</div>'.($impressions > 10 ? '' : '<div class="chart-outer-label">'.$row['impressions'].'</div>').'<br />' : '').'
		...
		'.($ulp->ext_options['count_impressions'] == 'on' ? '<div class="chart ctr-chart" style="width: '.$ctr.'%;">'.($ctr > 10 ? ($row['impressions'] > 0 ? number_format($row['clicks']*100/$row['impressions'], 2, ".", "").'%' : '0%') : '&nbsp').'</div>'.($ctr > 10 ? '' : '<div class="chart-outer-label">'.($row['impressions'] > 0 ? number_format($row['clicks']*100/$row['impressions'], 2, ".", "").'%' : '0%').'</div>') : '').'
	</div>';
							}
							echo '
	<hr>
	<div class="popup-charts">
		...
		'.($ulp->ext_options['count_impressions'] == 'on' ? '<div class="legend-chart impressions-chart">'.__('Impressions', 'ulp').'</div>' : '').'
		<div class="legend-chart clicks-chart">'.__('Submits', 'ulp').'</div>
		'.($ulp->ext_options['count_impressions'] == 'on' ? '<div class="legend-chart ctr-chart">'.__('CTR', 'ulp').'</div>' : '').'
	</div>
